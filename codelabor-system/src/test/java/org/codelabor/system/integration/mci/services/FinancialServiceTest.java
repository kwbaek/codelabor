package org.codelabor.system.integration.mci.services;
...
public class FinancialServiceTest extends AbstractDependencyInjectionSpringContextTests {
	...
	public void onSetUp() throws Exception {
		financialService = (FinancialService) applicationContext.getBean("example.integration.mci.financialService");
	}
