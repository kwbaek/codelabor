 ...
 */
package anyframe.core.query.impl.util.test;

import java.sql.Types;

import anyframe.core.query.impl.util.AbstractPagingSQLGenerator;
...
public class DB2PagingSQLGenerator extends AbstractPagingSQLGenerator {
	...
	public String getPaginationSQL(String originalSql, Object[] originalArgs,
		...
		setArgs(originalArgs, pageIndex, pageSize);
		setArgTypes(originalArgTypes);
	...
	private void setArgs(Object[] originalArgs, int pageIndex, int pageSize) {
		args = new Object[originalArgs.length + 2];
	...
	private void setArgTypes(int[] originalArgTypes) {
		argTypes = new int[originalArgTypes.length + 2];
	 ...
	 * @return if original SQL includes DISTINCT, return true. else return
	 *         false.
	 */
	 ...
	 * @param sql
	 *            trimmed original SQL
	 * @return if original SQL includes *, return true. else return false.
	 */
	...
	/**
	 * Check if original SQL includes ORDER BY. <br/> We don't permit a column
	 * name like 'ORDERBY'.
	 * 
	 * @param sql
	 *            trimmed original SQL
	 * @return if original SQL includes ORDER BY, return true. else return
	 *         false.
	 */
