								...
								<tbody>
									...
									<c:forEach var="fileDTO" items="${requestScope['org.codelabor.system.file.FILE_LIST']}">
										<tr class="b">
											...
											<td>
												<a href="<c:url value='/servlet/system/file/fileUploadServlet?method=download&fileId=${fileDTO.fileId}'/>"><spring:message code="button.download"/></a>
												<a href="<c:url value='/servlet/system/file/fileUploadServlet?method=view&fileId=${fileDTO.fileId}'/>"><spring:message code="button.view"/></a>
											</td>
