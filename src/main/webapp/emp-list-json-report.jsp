...
<title>emp list json report</title>
...
<script language="javascript">
	function report() {
		...
		var oAjax = rex_gfAjaxExcute("POST", false, rex_gfGetLocationHost() + "/servlet/empListJsonServlet", sParam, "CSV", sContentType);
