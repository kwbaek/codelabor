 ...
 * 
 */
public class LastIndexTag extends SimpleTagSupport {

	private final static Logger logger = LoggerFactory
			.getLogger(LastIndexTag.class);
	...
	public void doTag() throws JspException, IOException {
		...
		// last page number of last
		logger.debug("lastPageNoOnLastIndex: {}",
				parent.getLastPageNoOnLastIndex());
		StringBuilder sb = new StringBuilder();
		sb.append(this.generateAnchorTagForLastIndex(parent.getQueryString(),
				parent.getLastPageNoOnLastIndex(), parent.getMaxRowPerPage()));
