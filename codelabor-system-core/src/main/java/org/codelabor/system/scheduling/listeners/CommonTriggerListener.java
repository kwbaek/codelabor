 ...
 */
package org.codelabor.system.scheduling.listeners;
...
public class CommonTriggerListener implements TriggerListener {
	...
	protected Log log = LogFactory.getLog(CommonTriggerListener.class);
	...
	public String getName() {
		return CommonTriggerListener.class.toString();
	}
