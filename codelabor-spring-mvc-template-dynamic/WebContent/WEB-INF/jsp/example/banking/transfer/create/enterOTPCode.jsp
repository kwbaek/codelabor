...
<%@ taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
				...
				<div class="section">
					...
					<div class="section">
					<h4><spring:message code="label.example.banking.transfer.otp"/></h4>
					<table class="bodyTable">
						<tbody>
							<tr class="b">
								<th><spring:message code="label.example.banking.transfer.otp.password"/></th>
								<td>
									<form:password path="otpPassword" />
									<form:errors path="otpPassword"/>
								</td>
							</tr>
						</tbody>
					</table>
