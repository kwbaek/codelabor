 ...
 * 
 */
public class PreviousIndexTag extends SimpleTagSupport {
	...
	public void doTag() throws JspException, IOException {
		...
		logger.debug("firstPageNoOnPreviousIndex: {}",
				parent.getFirstPageNoOnPreviousIndex());
		StringBuilder sb = new StringBuilder();
		sb.append(this.generateAnchorTagForPreviousIndex(
