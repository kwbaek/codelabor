...
<link type="text/css" rel="stylesheet" href="${contextPath}/css/common/jquery.placeholder.css" />
	...
	<form:form commandName="personDto">
		...
		<table>
			<tr>
				...
				<td>필수입력</td>
				<td>
				<input type="text" id="username" name="username" placeholder="아이디는 필수 입력 항목입니다." maxlength="12"></input>
				</td>
			...
			<tr>
				...
				<td>특수문자입력불가</td>
				<td>
				<input type="text" id="tttt" name="tttt" placeholder="아이디는 필수 입력 항목입니다." maxlength="12"></input>
				</td>
				<td><form:errors path="username" /></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2">
					<input id="formBtn" type="button" value="<spring:message code="button.save" />" />
