...
<link href="${pageContext.request.contextPath}/css/common/style.css"
	rel="stylesheet" type="text/css" />
<link
...
<body>
	...
	${serverTime}
	<ul>
		<li><a href="${pageContext.request.contextPath}/example">Example</a></li>
		<li><a href="${pageContext.request.contextPath}/examcommon">Common</a></li>
