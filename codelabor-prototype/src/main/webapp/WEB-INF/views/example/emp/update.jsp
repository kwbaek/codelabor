...
<title><spring:message code="title.emp.update" /> <system:properties key="con.name" /></title>
</head>
<body>
<h1><spring:message code="heading.emp.update" /></h1>
<hr/>
...
<table>
	<tr>
		...
		<td><form:input path="empNo" type="hidden" />${empDto.empNo}<span><form:errors path="empNo" /></span></td>
	</tr>
	<tr>
