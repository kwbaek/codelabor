...
<title><spring:message code="title.emp.update" /></title>
</head>
<body>
	<h1>
	...
	<form:form commandName="empDto">
		...
		<table>
			<tr>
				...
				<td><form:input path="empNo" type="hidden" />${empDto.empNo}<span><form:errors
							path="empNo" /></span></td>
			</tr>
			<tr>
				<th><label for="ename"><spring:message
							code="label.emp.ename" /></label></th>
				<td><form:input path="ename" placeholder="length max 10" /><span><form:errors
							path="ename" /></span></td>
			</tr>
			<tr>
				<th><label for="deptNo"><spring:message
							code="label.emp.deptNo" /></label></th>
				<td><form:select path="deptNo" items="${deptMap}" /> <span><form:errors
							path="deptNo" /></span></td>
			</tr>
			<tr>
				<th><label for="job"><spring:message
							code="label.emp.job" /></label></th>
				<td><form:input path="job" placeholder="length max 9" /><span><form:errors
							path="job" /></span></td>
			</tr>
			<tr>
				<th><label for="hireDate"><spring:message
							code="label.emp.hireDate" /></label></th>
				<td><form:input path="hireDate" placeholder="yyyy-MM-dd" /><span><form:errors
							path="hireDate" /></span></td>
			</tr>
			<tr>
				<th><label for="mgr"><spring:message
							code="label.emp.mgrName" /></label></th>
				<td><form:select path="mgr" items="${mgrMap}" /> <span><form:errors
							path="mgr" /></span></td>
			</tr>
			<tr>
				<th><label for="comm"><spring:message
							code="label.emp.comm" /></label></th>
				<td><form:input path="comm" placeholder="integer 7, fraction 2" /><span><form:errors
							path="comm" /></span></td>
			</tr>
			<tr>
				<th><label for="sal"><spring:message
							code="label.emp.sal" /></label></th>
				<td><form:input path="sal" placeholder="integer 7, fraction 2" /><span><form:errors
							path="sal" /></span></td>
			</tr>
		</table>
		<hr />
