...
public class NextIndexTag extends SimpleTagSupport {
	...
	public void doTag() throws JspException, IOException {
		...
		logger.debug("firstPageNoOnNextIndex: {}",
				parent.getFirstPageNoOnNextIndex());
		StringBuilder sb = new StringBuilder();
		sb.append(this.generateAnchorTagForNextIndex(parent.getQueryString(),
				parent.getFirstPageNoOnNextIndex(), parent.getMaxRowPerPage()));
