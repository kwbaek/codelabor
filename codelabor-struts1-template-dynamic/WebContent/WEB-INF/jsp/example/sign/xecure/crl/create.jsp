...
<%@ taglib uri="http://struts.apache.org/tags-html" prefix="html"%>
				...
				<h2><spring:message code="label.example.sign.crl"/></h2>
				<p></p>
				<div class="section">
				<h3><spring:message code="label.example.sign.create"/></h3>
				<p></p>
				<html:form action="/example/sign/xecure/crl/processCreate.do" onsubmit="signForm.signedMessage.value = Sign_with_option(0, signForm.plainMessage.value);return XecureSubmit(this);">
