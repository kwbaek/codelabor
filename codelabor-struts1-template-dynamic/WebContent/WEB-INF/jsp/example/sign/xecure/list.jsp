...
<%@ taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
				...
				<div class="section">
					...
					<hr />
					<a href="<c:url value='/example/sign/xecure/crl/prepareCreate.do'/>"><spring:message code="button.sign.crl"/></a>
					<a href="<c:url value='/example/sign/xecure/ocsp/prepareCreate.do'/>"><spring:message code="button.sign.ocsp"/></a>
				</div>
