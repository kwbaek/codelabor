...
<%@ taglib uri="http://www.springframework.org/tags" prefix="spring" %>
					...
					<div class="section">
						...
						<p></p>
						<form action="<c:url value='/example/file/uploadFile.do?method=delete'/>" method="post">
								...
								<tbody>
									...
									<c:forEach var="fileDTO" items="${requestScope['org.codelabor.system.file.FILE_LIST']}">
										<tr class="b">
											...
											<td>
												<a href="<c:url value='/example/file/downloadFile.do?fileId=${fileDTO.fileId}'/>">${fileDTO.realFileName}</a>
											</td>
					...
					<div class="section">
						...
						<form
							action="<c:url value='/example/file/uploadFile.do?method=upload&repositoryType=FILE_SYSTEM&mapId=${mapId}'/>"
					...
					<div class="section">
						...
						<form
							action="<c:url value='/example/file/uploadFile.do?method=upload&repositoryType=DATABASE&mapId=${mapId}'/>"
							method="post" enctype="multipart/form-data">
							<table class="bodyTable">
								<tr class="b">
									<th><spring:message code="label.system.file.map.id"/></th>
