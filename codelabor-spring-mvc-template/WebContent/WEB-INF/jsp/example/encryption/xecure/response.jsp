...
<%@ taglib uri="http://www.springframework.org/tags" prefix="spring" %>
					...
					<div class="section">
						...
						<ul>
						<li>param1=value1, param2=value2 <a href="<c:url value='/servlet/system/sniffer/xecureSnifferServlet?param1=value1&param2=value2'/>" target="_blank" onclick="return XecureLink(this);">[test]</a></li>
						</ul>
					</div>