...
<%@ taglib uri="http://www.springframework.org/tags" prefix="spring" %>	
					...
					<ul>
					<li>param1=value1, param2=value2 <a href="<c:url value='/servlet/snifferServlet?param1=value1&param2=value2'/>" target="_blank" onclick="return XecureLink(this);">[test]</a></li>
					</ul>